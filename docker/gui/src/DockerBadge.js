/**
 * DockerBadge — 서버 카드 아이콘 위의 Docker 배지
 * 슬롯: ServerCard.badge
 */
...
export default function DockerBadge({ server }) {
  ...
  return (
    <span className="docker-badge" title="Docker" style={{
      position: 'absolute',
      bottom: '-3px',
      right: '-3px',
      width: '18px',
